...
\titleformat{\chapter}[hang]{\Huge\bfseries\scshape}{\thechapter\hspace{20pt}\textcolor{gray75}{|}\hspace{20pt}}{0pt}{\Huge\bfseries}
...
\begin{figure}[h]
    \centering
    \begin{tikzpicture}
    \foreach \y in {0,0.15,...,0.61} {
        \draw (0.00, \y) -- (0.766, \y);
        \draw (3.234, \y) -- (4.0, \y);
    }
    \node[above] at (2.0, 0) {$\cdots$};
    \node[above] at (4.5, 0) {\Vier};
    \draw[brace, decoration={raise=0.5ex}] (0, 0) -- (4, 0) node [position label, pos=0.5] {$n - 1$ beats};
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \node[above] at (2.0, 0) {$\cdots$};
    \node[above] at (4.5, 0) {\Halb};
    \draw[brace, decoration={raise=0.5ex}] (0, 0) -- (4, 0) node [position label, pos=0.5] {$n - 2$ beats};
    \end{tikzpicture}
